...
import { UniswapChain } from './common'
import { storePriceHistoryInDb } from './uniswap'
...
async function scrape() {
    ...
    storePriceHistoryInDb({
        dataSource,
        key: UniswapChain.V3_L1,
        provider: new providers.InfuraProvider('homestead', '<ENTER YOUR KEY>'),
        poolAddress: '0x88e6a0c2ddd26feeb64f039a2c41296fcb3f5640', // https://info.uniswap.org/#/pools/...
        tokenA: new Token(ChainId.MAINNET, '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48', 6, 'USDC', 'USD Coin'),
        tokenB: new Token(ChainId.MAINNET, '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2', 18, 'WETH', 'Wrapped Ether'),
    })
